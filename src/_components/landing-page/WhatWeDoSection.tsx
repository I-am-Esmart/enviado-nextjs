...
import { Swiper as SwiperType } from "swiper" // TypeScript type for Swiper
      ...
      <div className={`h-[75%] w-full`}>
        ...
        >
          <SwiperSlide className={`h-full`}>
            <div
              className={`h-full -rotate-12 py-10 px-5 flex items-center justify-center`}
            >
              <div
              ...
              >
                ...
                >
                  ...
                  foundation for something extraordinary.
                </p>
          ...
          <SwiperSlide className={`h-full`}>
            <div
              className={`h-full py-10 px-5 flex items-center justify-center`}
            >
              <div
                className={`relative h-full w-full shadow-lg bg-[#FAECEB] py-5 px-3 md:py-8 md:px-4`}
              >
                ...
                >
                  ...
                  give your brand the edge it needs to stand out.
                </p>
                <div className={`flex items-center justify-end`}>
                  <Image
                    src={Discovery_Motion_Design_Icon}
                    alt="discovery-motion"
                    width={0}
                    height={0}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  expanding your brand’s presence and driving sustained growth.
                </p>
